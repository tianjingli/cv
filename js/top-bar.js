!function () {
    ...
    1: [function (t, e, i) {
        "use strict";
        var n = t("./helpers/TabManager"), s = t("./helpers/hideSiblingElements"),
            r = t("./helpers/showSiblingElements"), a = function (t, e) {
    ...
    }, {"./helpers/TabManager": 2, "./helpers/hideSiblingElements": 4, "./helpers/showSiblingElements": 7}],
    2: [function (t, e, i) {
        "use strict";
        var n = t("./../maps/focusableElement"), s = function () {
    ...
    3: [function (t, e, i) {
        "use strict";
        var n = t("./../maps/ariaMap"), s = t("./TabManager"), r = "data-original-", a = "tabindex",
            o = function (t, e) {
                var i = t.getAttribute(r + e);
                i || (i = t.getAttribute(e) || "", t.setAttribute(r + e, i))
            };
        e.exports = function (t, e) {
            if (s.isFocusableElement(t, e)) o(t, a), t.setAttribute(a, "-1"); else for (var i = s.getTabbableElements(t, e), r = i.length; r--;) o(i[r], a), i[r].setAttribute(a, "-1");
            o(t, n.HIDDEN), t.setAttribute(n.HIDDEN, "true")
        }
    }, {"./../maps/ariaMap": 8, "./TabManager": 2}],
    4: [function (t, e, i) {
        "use strict";
        var n = t("./hide");
    ...
    6: [function (t, e, i) {
        "use strict";
        var n = t("./removeAttributes"), s = t("./../maps/ariaMap"), r = "data-original-", a = "tabindex",
            o = function (t, e) {
                var i = t.getAttribute(r + e);
    ...
    }, {"./../maps/ariaMap": 8, "./removeAttributes": 5}],
    7: [function (t, e, i) {
        "use strict";
        var n = t("./show");
    ...
    12: [function (t, e, i) {
        "use strict";
        var n = t("../isNodeType"), s = t("../NODE_TYPES"), r = s.COMMENT, a = s.DOCUMENT_FRAGMENT, o = s.ELEMENT,
            c = s.TEXT, h = [o, c, r, a], u = " must be an Element, TextNode, Comment, or Document Fragment",
            l = [o, c, r], m = " must be an Element, TextNode, or Comment", d = [o, a],
            f = " must be an Element, or Document Fragment", _ = " must have a parentNode";
        e.exports = {
    ...
    18: [function (t, e, i) {
        ...
        function n() {
            var t = s.getWindow(), e = s.getDocument(), i = s.getNavigator();
            return !!("ontouchstart" in t || t.DocumentTouch && e instanceof t.DocumentTouch || i.maxTouchPoints > 0 || i.msMaxTouchPoints > 0)
        }

        var s = t("./helpers/globals"), r = t("@marcom/ac-function/once");
        e.exports = r(n), e.exports.original = n
    }, {"./helpers/globals": 17, "@marcom/ac-function/once": 19}],
    19: [function (t, e, i) {
        "use strict";
        e.exports = function (t) {
            var e;
    ...
    21: [function (t, e, i) {
        "use strict";
        var n = t("@marcom/ac-dom-nodes/isNodeType"), s = t("@marcom/dom-traversal/ancestor"),
            r = t("@marcom/feature-detect/cssPropertyAvailable"), a = t("@marcom/viewport-emitter/ViewportEmitter"),
            o = t("@marcom/ac-accessibility/CircularTab"), c = t("./internal/CheckboxMenu"),
            h = t("./internal/SimpleSticky"), u = t("./internal/ClickAway"), l = t("@marcom/ac-dom-nodes/NODE_TYPES"),
            m = l.ELEMENT, d = {className: "localnav"}, f = function (t, e) {
                var i;
    ...
    22: [function (t, e, i) {
        ...
        var r = s.prototype, a = n.prototype = Object.create(r);
    ...
    23: [function (t, e, i) {
        ...
        var s = t("@marcom/ac-event-emitter-micro/EventEmitterMicro"), r = t("@marcom/dom-traversal/ancestors"),
            a = s.prototype, o = n.prototype = Object.create(a);
    ...
    }, {"@marcom/ac-event-emitter-micro/EventEmitterMicro": 16, "@marcom/dom-traversal/ancestors": 46}],
    24: [function (t, e, i) {
        "use strict";
        var n = t("@marcom/ac-event-emitter-micro").EventEmitterMicro,
            s = t("@marcom/feature-detect/cssPropertyAvailable"), r = t("@marcom/ac-dom-nodes/insertBefore"),
            a = t("@marcom/dom-metrics/getScrollPosition"), o = t("@marcom/useragent-detect"), c = "css-sticky",
            h = o.browser.edge, u = function (t, e) {
        ...
        var l = n.prototype, m = u.prototype = Object.create(l);
        u.prototype.constructor = u, m._featureDetection = function () {
            var t = s("position", "sticky") && !h, e = c;
    ...
    25: [function (t, e, i) {
        "use strict";
        var n = t("./shared/stylePropertyCache"), s = t("./shared/getStyleTestElement"), r = t("./utils/toCSS"),
            a = t("./utils/toDOM"), o = t("./shared/prefixHelper"), c = function (t, e) {
                var i = r(t), s = e !== !1 && r(e);
        ...
        e.exports = function (t) {
            ...
            for (r = s(), t = a(t), i = t.charAt(0).toUpperCase() + t.substring(1), e = "filter" === t ? ["WebkitFilter", "filter"] : (t + " " + o.dom.join(i + " ") + i).split(" "), h = 0; h < e.length; h++) if ("undefined" != typeof r.style[e[h]]) return 0 !== h && o.reduce(h - 1), c(t, e[h]);
            return c(t, !1)
        }
    }, {
    ...
    26: [function (t, e, i) {
        "use strict";
        var n = t("./getStyleProperty"), s = t("./shared/styleValueAvailable"), r = t("./shared/prefixHelper"),
            a = t("./shared/stylePropertyCache"), o = {}, c = /(\([^\)]+\))/gi, h = /([^ ,;\(]+(\([^\)]+\))?)/gi;
        e.exports = function (t, e) {
            var i;
            return e += "", !!(t = n(t)) && (s(t, e) ? e : (i = a[t].css, e = e.replace(h, function (e) {
                ...
                for (n = r.css.map(function (t) {
                    return t + e
                }), n = [e].concat(n), u = 0; u < n.length; u++) if (s(t, n[u])) return 0 !== u && r.reduce(u - 1), o[h] = n[u].replace(c, ""), n[u];
                return o[h] = !1, ""
            }), e = e.trim(), "" !== e && e))
        }
    }, {
    ...
    28: [function (t, e, i) {
        "use strict";
        var n = ["-webkit-", "-moz-", "-ms-"], s = ["Webkit", "Moz", "ms"], r = ["webkit", "moz", "ms"],
            a = function () {
                this.initialize()
            }, o = a.prototype;
    ...
    }, {"./getStyleTestElement": 27, "./stylePropertyCache": 29}],
    31: [function (t, e, i) {
        "use strict";
    ...
    34: [function (t, e, i) {
        ...
        var s, r = t("@marcom/ac-event-emitter-micro").EventEmitterMicro, a = t("./sharedRAFExecutorInstance"),
    ...
    36: [function (t, e, i) {
        "use strict";
        var n = t("./SingleCallRAFEmitter"), s = function (t) {
    ...
    37: [function (t, e, i) {
        "use strict";
        var n = t("./RAFInterface"), s = function () {
            this.events = {}
        }, r = s.prototype;
    ...
    38: [function (t, e, i) {
        "use strict";
        var n = t("./RAFEmitter"), s = function (t) {
            n.call(this, t)
    ...
    39: [function (t, e, i) {
        "use strict";
        var n = t("@marcom/ac-shared-instance").SharedInstance, s = t("../.release-info.js").majorVersionNumber,
            r = function () {
                this._currentID = 0
            };
    ...
    }, {"../.release-info.js": 33, "@marcom/ac-shared-instance": 42}],
    40: [function (t, e, i) {
        "use strict";
        var n = t("@marcom/ac-shared-instance").SharedInstance, s = t("../.release-info.js").majorVersionNumber,
            r = t("./RAFExecutor");
        e.exports = n.share("@marcom/ac-raf-emitter/sharedRAFExecutorInstance", s, r)
    }, {"../.release-info.js": 33, "./RAFExecutor": 35, "@marcom/ac-shared-instance": 42}],
    41: [function (t, e, i) {
        "use strict";
    ...
    43: [function (t, e, i) {
        ...
        }, s = window, r = "AC", a = "SharedInstance", o = s[r], c = function () {
            var t = {};
            return {
                get: function (e, i) {
                    var n = null;
    ...
    44: [function (t, e, i) {
        ...
        e.exports = function (t, e) {
            ...
            var n = t === window;
            return e && /^[xy]$/i.test(e) ? s(t, e, n) : {x: s(t, "x", n), y: s(t, "y", n)}
        }
    }, {}],
    45: [function (t, e, i) {
        "use strict";
        var n = t("@marcom/ac-dom-nodes/isNodeType"), s = t("./internal/validate"),
        ...
        e.exports = function (t, e, i, a) {
            ...
            if (a = a || document.body, t !== a) for (; (t = t.parentNode) && n(t, r);) {
                if (!e || t.matches(e)) return t;
                if (t === a) break
            }
            return null
        }
    }, {"./internal/validate": 47, "@marcom/ac-dom-nodes/NODE_TYPES": 10, "@marcom/ac-dom-nodes/isNodeType": 14}],
    46: [function (t, e, i) {
        "use strict";
        var n = t("@marcom/ac-dom-nodes/isNodeType"), s = t("./internal/validate"),
            r = t("@marcom/ac-dom-nodes/NODE_TYPES").ELEMENT;
        e.exports = function (t, e, i, a) {
            var o = [];
            if (s.childNode(t, "ancestors"), s.selector(e, "ancestors"), i && n(t, r) && (!e || t.matches(e)) && o.push(t), a = a || document.body, t !== a) for (; (t = t.parentNode) && n(t, r) && (e && !t.matches(e) || o.push(t), t !== a);) ;
            return o
        }
    }, {"./internal/validate": 47, "@marcom/ac-dom-nodes/NODE_TYPES": 10, "@marcom/ac-dom-nodes/isNodeType": 14}],
    47: [function (t, e, i) {
        "use strict";
        var n = t("@marcom/ac-dom-nodes/isNodeType"), s = t("@marcom/ac-dom-nodes/NODE_TYPES"), r = s.COMMENT,
            a = s.DOCUMENT_FRAGMENT, o = s.DOCUMENT, c = s.ELEMENT, h = s.TEXT, u = [c, o, a],
            l = " must be an Element, Document, or Document Fragment", m = [c, h, r],
            d = " must be an Element, TextNode, or Comment", f = " must be a string";
        e.exports = {
    ...
    }, {"@marcom/ac-dom-nodes/NODE_TYPES": 10, "@marcom/ac-dom-nodes/isNodeType": 14}],
    48: [function (t, e, i) {
        "use strict";
        ...
        var s = t("@marcom/ac-prefixer/getStyleValue"), r = t("@marcom/ac-prefixer/getStyleProperty"),
    ...
    49: [function (t, e, i) {
        ...
        e.exports = function (t, e) {
            e = e || n;
            var i = function s() {
                var i = arguments, n = e.apply(this, i);
    ...
    52: [function (t, e, i) {
        ...
        function s(t, e) {
            ...
            "string" == typeof i && (i = [i]);
            for (var s, r = i.length, a = 0; a < r; a++) if (s = e.match(n(i[a])), s && s.length > 1) return s[1].replace(/_/g, ".");
            return !1
        }

        function r(t, e, i) {
            for (var n, r, a = t.length, o = 0; o < a; o++) if ("function" == typeof t[o].test ? t[o].test(i) === !0 && (n = t[o].name) : i.ua.indexOf(t[o].userAgent) > -1 && (n = t[o].name), n) {
        ...
        var o = t("./defaults"), c = t("./dictionary");
        e.exports = a
    }, {"./defaults": 50, "./dictionary": 51}],
    53: [function (t, e, i) {
        "use strict";
    ...
    54: [function (t, e, i) {
        ...
        Object.defineProperty(l, "id", {
            ...
            if (this._allowDOMEventDispatch) {
                var n = new CustomEvent(t, {detail: e}), s = new CustomEvent(u.any, {detail: i});
    ...
    }, {"@marcom/ac-event-emitter-micro": 15, "@marcom/ac-raf-emitter/update": 41}],
    55: [function (t, e, i) {
        "use strict";
        var n = t("@marcom/ac-localnav/Localnav"), s = t("@marcom/ac-headjs/FeatureDetect"),
            r = t("./featureDetectTests"), a = "locked", o = function (t) {
                var e = new s(t, r);
                e.htmlClass(), n.call(this, t, {className: "ac-ln", selector: "#ac-localnav"});
            ...
            }, c = n.prototype, h = o.prototype = Object.create(c);
    ...
    }, {"./featureDetectTests": 56, "@marcom/ac-headjs/FeatureDetect": 20, "@marcom/ac-localnav/Localnav": 21}],
    56: [function (t, e, i) {
        "use strict";
    ...
    57: [function (t, e, i) {
        "use strict";
        var n = t("./ac-localnav-global/LocalnavGlobal"), s = document.getElementById("ac-localnav");
        s && (e.exports = new n(s))
